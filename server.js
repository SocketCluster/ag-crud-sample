...
// SC/WebSocket connection handling loop.
(async () => {
...
let crudOptions = {
  ...
  middleware: {
    invoke: async function (action) {
      // This is a simplified interface for SC middleware for the invoke action.
      // To delay the action, use await.
      // To block the action, throw an Error.
    },
    transmit: async function (action) {
      // This is a simplified interface for SC middleware for the transmit action.
      // To delay the action, use await.
      // To block the action, throw an Error.
    },
    subscribe: async function (action) {
      // This is a simplified interface for SC middleware for the subscribe action.
      // To delay the action, use await.
      // To block the action, throw an Error.
    },
    publishIn: async function (action) {
      // This is a simplified interface for SC middleware for the publishIn action.
      // To delay the action, use await.
      // To block the action, throw an Error.
    },
    authenticate: async function (action) {
      // This is a simplified interface for SC middleware for the authenticate action.
      // To delay the action, use await.
      // To block the action, throw an Error.
    }
  }
